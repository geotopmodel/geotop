...
public:
  ...
  GeoVector<double> MELTED;  // this is the cumulative value of the melted
  // instant variable, unuseful with the new output
  GeoVector<double> SUBL;    // this is the cumulative value of the subl instant
  // variable, unuseful with the new output
  Glacier() {};
