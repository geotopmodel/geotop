...
{
public:
  static void aero_resistance(double zmu,
                              double zmt,
                              double z0,
                              double d0,
                              double z0_z0t,
  ...
  static void turbulent_fluxes(const double &rh,
                               const double &rv,
                               const double &P,
                               const double &Ta,
                               const double &T,
  ...
  static void find_actual_evaporation_parameters(long R,
                                                 long C,
                                                 double *alpha,
                                                 double *beta,
                                                 GeoVector<double> &evap_layer,
                                                 double *theta,
                                                 // double **soil, double *T,
                                                 // double psi, double P, double
                                                 // rv, double Ta, double Qa,
