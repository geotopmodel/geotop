...
// short EnergyBalance(double Dt, double JD0, double JDb, double JDe, SOIL_STATE
// *L, SOIL_STATE *C, STATEVAR_3D *S, STATEVAR_3D *G, STATE_VEG *V, DOUBLEVECTOR
// *snowage, ALLDATA *A, double *W, std::vector<mio::MeteoData>& vecmeteo);
...
// STATE_VEG *V,             DOUBLEVECTOR *snowage, ALLDATA *A,
//double E0, double Et, double Dtplot, double W, FILE *f, double *SWupabove_v,
//double *Tgskin);

// short PointEnergyBalance(long i, long r, long c, double Dt, double JDb,
// double JDe, SOIL_STATE *L, SOIL_STATE *C, Statevar3D *S, Statevar3D *G,
// STATE_VEG *V,             DOUBLEVECTOR *snowage, ALLDATA *A,
//double E0, double Et, double Dtplot, double W, FILE *f, double *SWupabove_v,
//double *Tgskin);
...
short SolvePointEnergyBalance(const short surfacemelting,
                              double Tgd,
                              double EBd,
                              double Convd,
...
// double calc_C(long l, long nsng, double a, double *wi, double *wl, double
// *dw, double *D, double **pa);
...
//          double d0s, double rz0s, double z0v, double d0v, double rz0v, double
//hveg, double v, double Ta, double Qa, double P, double LR,
//          double psi, double e, double fc, double LSAI, double decaycoeff0,
//double Wcrn, double Wcrnmax, double Wcsn, double Wcsnmax,
//          double *dWcrn, double *dWcsn, double *theta, double **soil, double
//*land, double *root, PAR *par, DOUBLEVECTOR *soil_transp_layer,
//          double SWin, double LWin, double SWv, double *LW, double *H, double
//*dH_dT, double *E, double *dE_dT, double *LWv, double *Hv,
//          double *LEv, double *Etrans, double *Tv, double *Qv, double *Ts,
//double *Qs, double *Hg0, double *Hg1, double *Eg0,
//          double *Eg1, double *Lobukhov, double *rh, double *rv, double *rc,
//double *rb, double *ruc, double *rh_g,
//          double *rv_g, double *Qg, double *u_top, double *decay, double
//*Locc, double *LWup_above_v, double *T,           DOUBLEVECTOR
//*soil_evap_layer_bare, DOUBLEVECTOR *soil_evap_layer_veg, double point_elev,
//double point_slope, double point_aspect, double point_sky, int point_lc, long
//point_sy, double snowD);
...
//rz0v, double hveg, double v, double Ta, double Qa, double P, double LR,
//                  double psi, double e, double fc, double LSAI, double
//decaycoeff0, double Wcrn, double Wcrnmax, double Wcsn, double Wcsnmax,
//                  double *dWcrn, double *dWcsn, double *theta, double **soil,
//double *land, double *root, PAR *par, DOUBLEVECTOR *soil_transp_layer,
//                  double SWin, double LWin, double SWv, double *LW, double *H,
//double *dH_dT, double *E, double *dE_dT, double *LWv, double *Hv,
//                  double *LEv, double *Etrans, double *Tv, double *Qv, double
//*Ts, double *Qs, double *Hg0, double *Hg1, double *Eg0,
//                  double *Eg1, double *Lobukhov, double *rh, double *rv,
//double *rc, double *rb, double *ruc, double *rh_g,
//                  double *rv_g, double *Qg, double *u_top, double *decay,
//double *Locc, double *LWup_above_v, double *T,
//                  DOUBLEVECTOR *soil_evap_layer_bare, DOUBLEVECTOR
//*soil_evap_layer_veg, short flagTmin, long cont);
...
// *ad, DOUBLEVECTOR *ads, DOUBLEVECTOR *b, DOUBLEVECTOR *e, double *T,
// SHORTVECTOR *mf);
