...
namespace geotop
{
  namespace input
  {
    ...
    static std::vector<stringpair_s> StandardNames =
      std::vector<stringpair_s>((size_t)UNKNOWN_VAR);

    static void fillStandardName(size_t index,
      ...
      if (not init)
        {
          ...
          fillStandardName(SOIL_WATER_CONTENT, "SoilWaterContent", "SoilTh",
                           "mm");
          fillStandardName(SOIL_ICE_CONTENT, "SoilIceContent", "SoilThI", "mm");
          fillStandardName(SOIL_WATER_PRESSURE, "SoilWaterPressure", "SoilP",
                           "m");
          fillStandardName(SOIL_TOTAL_PRESSURE, "SoilTotalPressure", "SoilTotP",
                           "m");
          // fillStandardName(SOIL_ET, "SoilEvapotranspiration", "SoilET", "-");
          // SOIL MAP VARIABLES
          fillStandardName(SOIL_CAN_RAIN, "SoilCanopyInterceptedRain",
                           "SoilCanRain", "mm");
          fillStandardName(SOIL_CAN_SNOW, "SoilCanopyInterceptedSnow",
                           "SoilCanSnow", "mm");
          // SNOW MAP VARIABLES
          ...
          fillStandardName(ENER_LWin, "EnergyIncomingLongWave", "EnerInLW",
                           "W/m2");
          ...
          fillStandardName(ENER_SWin, "EnergyIncomingShortWave", "EnerInSW",
                           "W/m2");
          fillStandardName(ENER_SWinb, "EnergyDirectIncomingShortWave",
                           "EnerDISW", "W/m2");
