...
void canopy_fluxes(long r, long c, double Tv, double Tg, double Ta,
                   ...
                   double decaycoeff0, MatrixRow<double> &&land, double Wcrn, double Wcrnmax, double Wcsn,
                   ...
                   MatrixRow<double> &&froot, double *theta, Vector<double> *soil_transp_layer, long chgsgn,
...
void canopy_evapotranspiration(double rbv, double Tv, double Qa, double Pa,
                               double SWin, double *theta, MatrixRow<double> &&land, double **soil,
                               MatrixRow<double> &&root, double *f, Vector<double> *fl);
