        ...
        do
        {
          ...
          if ((*snow->w_ice)(l,r,c) > SWEmax_layer*2.)
          {
            ...
            (*snow->Dzl)(l+1,r,c) = (*snow->Dzl)(l,r,c) * SWEmax_layer /
                                    (*snow->w_ice)(l,r,c);
            (*snow->w_liq)(l+1,r,c) = (*snow->w_liq)(l,r,c) * SWEmax_layer /
                                      (*snow->w_ice)(l,r,c);
                       ...
                       long l2, long lres)
{
  ...
  h = internal_energy((*snow->w_ice)(l1,r,c),(*snow->w_liq)(l1,r,c), (*snow->T)(l1,r,c))
      + internal_energy((*snow->w_ice)(l2,r,c), (*snow->w_liq)(l2,r,c),(*snow->T)(l2,r,c));
  ...
  from_internal_energy(a, r+6000,c+6000,h,&((*snow->w_ice)(lres,r,c)),
                          ...
                          double *w_liq, double *T)
{
  ...
  if (SWE>0)
  {
    *T=0.0;
    ...
    {
      T0 = *T;
      *T = T0-(pow(T0,3.0)+A*pow_2(T0)+B*T0+C)/(3.0*pow_2(T0)+2*A*T0+B);
      cont++;
...
void write_snow(long r, long c, long l, STATEVAR_3D *snow)
{
  ...
  printf("r:%ld c:%ld wice(%ld/%ld):%f wliq(%ld):%f T(%ld):%f Dz(%ld):%f\n",r,c,
         l,(*snow->lnum)(r,c),(*snow->w_ice)(l,r,c),l,(*snow->w_liq)(l,r,c),
                   ...
                   long l2, double Dmin)
{
  ...
  {
    f = std::min<double>(Dmin - (*snow->Dzl)(l1,r,c),
    ...
    from_internal_energy(a, r+1000, c+1000, h, &((*snow->w_ice)(l1,r,c)),
                         &((*snow->w_liq)(l1,r,c)), &((*snow->T)(l1,r,c)));
    return 1;
  }
  else
  {
                   ...
                   long l2, double Dmax)
{
  ...
  if ((*snow->Dzl)(l1,r,c) > Dmax) //l1 too thick and gives mass to l2
  {
    ...
    from_internal_energy(a, r+2000, c+2000, h, &((*snow->w_ice)(l2,r,c)),
                         &((*snow->w_liq)(l2,r,c)), &((*snow->T)(l2,r,c)));
    return 1;
  }
  else
  {
                      ...
                      long l2, double wicemin)
{
  ...
  {
    f = std::min<double>(wicemin - (*snow->w_ice)(l1),
...
void update_snow_age(double Psnow, double Ts, double Dt, double Prestore, double *tsnow_nondim)
{
  ...
  *tsnow_nondim = std::max<double>( 0.0, (*tsnow_nondim+(r1+r2+r3)*Dt*1.0E-6)*(1.0-Psnow/Prestore) );
...
double k_thermal_snow_Sturm(double density)   //W m^-1 K^-1 (Sturm, 1997)
{
  ...
  {
    kt = 0.138-1.01*density + 3.233*pow_2(density);
  }
  return (kt);
}
...
void glac2snow(double a, long r, long c, STATEVAR_3D *snow, STATEVAR_3D *glac)
{
  ...
  if (ns>0) from_internal_energy(a, r, c, h, &((*snow->w_ice)(1,r,c)),
                                 &((*snow->w_liq)(1,r,c)), &((*snow->T)(1,r,c)));
...
void snow2glac(double a, long r, long c, STATEVAR_3D *snow, STATEVAR_3D *glac)
{
  ...
  h = internal_energy((*snow->w_ice)(1,r,c),(*snow->w_liq)(1,r,c),
                      (*snow->T)(1,r,c));
  if (ng>0)
    h += internal_energy((*glac->w_ice)(ng,r,c), (*glac->w_liq)(ng,r,c), (*glac->T)(ng,r,c));

  (*glac->Dzl)(std::max<long>(ng,1),r,c) += (*snow->Dzl)(1,r,c);
  (*glac->w_ice)(std::max<long>(ng,1),r,c) += (*snow->w_ice)(1,r,c);
  (*glac->w_liq)(std::max<long>(ng,1),r,c) +=(*snow->w_liq)(1,r,c);
  if (ng>0)
    from_internal_energy(a, r, c, h, &((*glac->w_ice)(ng,r,c)), &((*glac->w_liq)(ng,r,c)), &((*glac->T)(ng,r,c)));
  ...
  for (l=(*snow->lnum)(r,c); l>=1; l--)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        (*snow->w_ice)(l,r,c) = std::max<double>(0., (*E->ice)(m) - (*E->deltaw)(m) - Edt);
        (*snow->w_liq)(l,r,c) = std::max<double>(0., (*E->liq)(m) + (*E->deltaw)(m) + Wdt);
              ...
              double Dz, double T)
{
  ...
  else
  {
    ...
    from_internal_energy(a, r, c, h, &((*snow->w_ice)(ns,r,c)),
  ...
  for (l=(*glac->lnum)(r,c); l>=1; l--)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        (*glac->w_ice)(l,r,c) = std::max<double>(0., (*E->ice)(m) - (*E->deltaw)(m) - Edt);
        (*glac->w_liq)(l,r,c) = std::max<double>(0., (*E->liq)(m) + (*E->deltaw)(m));
...
double dtheta_snow(double a, double b, double T)
{
  ...
  dth=-2.*a*a*T/pow_2(b+pow_2(a*T));
  if (T>0) dth=-2.*a*a*max_dtheta_snow(a,b)/pow_2(b+pow_2(a*max_dtheta_snow(a,b)));
  return (dth);
}
