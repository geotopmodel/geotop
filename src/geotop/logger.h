...
namespace geotop
{
  namespace logger
  {
    ...
    const std::string severity_labels[] = {"TRACE",   "DEBUG", "NOTICE",
    ...
    public:
       ...
       *
       */
      void addOStream(std::ostream *stream,
                      severity_levels minSeverity = DEFAULT_SEVERITY);
      ...
      void log(std::string const &message,
               severity_levels severity = DEFAULT_SEVERITY);
