...
// short Richards3D(double Dt, SOIL_STATE *L, SOIL_STATE *C, ALLDATA *adt, FILE
// *flog, double *loss, DOUBLEVECTOR *Vsub, double *Vbottom, double *Vlatsub,
...
// double *loss, double *Vbottom, double *Vlat, double *Total_Pnet, short
// updateK);
...
// int find_matrix_K_3D(double Dt, SOIL_STATE *SL, SOIL_STATE *SC, DOUBLEVECTOR
// *Lx, DOUBLEMATRIX *Klat, DOUBLEMATRIX *Kbottom_l, DOUBLEVECTOR *Kbottom_ch,
// ALLDATA *adt, DOUBLEVECTOR *H);
...
// int find_f_1D(long c, double Dt, SoilState *L, DOUBLEVECTOR *f, ALLDATA *adt,
...
// void find_dt_max(double Courant, double *h, LAND *land, TOPO *top, CHANNEL
// *cnet, PAR *par, METEO *met, double t, double *dt);
...
// void supflow(double Dt, double t, double *h, double *dV, double *hch, double
// *dhch, TOPO *top, LAND *land, WATER *wat, CHANNEL *cnet,
//       PAR *par, METEO *met, DOUBLEVECTOR *Vsup, double *Voutnet, double
//*Voutland, FILE *flog);
...
// WATER *wat, CHANNEL *cnet, PAR *par, DOUBLEVECTOR *Vsup, FILE *flog, long
// *cnt);
...
// void channel_flow(double Dt, double t, short DDcomplex, double *h, double
// *dV, TOPO *top, CHANNEL *cnet, PAR *par, LAND *land, double *Vout, FILE *f,
// long *cnt);
...
// void find_dt_max_channel(short DDcomplex, double Courant, double *h, TOPO
// *top, CHANNEL *cnet, PAR *par, LAND *land, double t, double *dt);
...
// void draining_land(double alpha, long i, TOPO *T, LAND *L, PAR *P, double *h,
// long *I, double *Q);
