...
inline short tridiag(short a, long r, long c, long nx, Vector<double> *diag_inf,
...
inline short tridiag2(short  /*a*/, long  /*r*/, long  /*c*/, long nbeg, long nend,
...
inline double norm_inf(Vector<double> *V, long nbeg, long nend)
{
...
inline double norm_2(Vector<double> *V, long nbeg, long nend)
{
...
inline double norm_1(Vector<double> *V, long nbeg, long nend)
{
...
inline void Cramer_rule(double A, double B, double C, double D, double E, double F,
                 double *x, double *y)
{
...
inline double minimize_merit_function(double res0, double lambda1, double res1,
...
inline double product(Vector<double> *a, Vector<double> *b)
{
    double p=0.;
    long i,n=a->nh;
...
//
inline double adaptiveSimpsonsAux(double (*f)(double), double a, double b,
                           double epsilon,
...
// from http://en.wikipedia.org/wiki/Adaptive_Simpson%27s_method
//
inline double adaptiveSimpsonsAux2(double (*f)(double x, void *p), void *arg,
