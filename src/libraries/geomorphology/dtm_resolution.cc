...
//1 known, 2 unknown
void reduce_resolution(long n, DOUBLEMATRIX *DTM1, DOUBLEMATRIX *DTM2,
                       T_INIT *UV1, T_INIT *UV2)
{
...
//1 known, 2 unknown
void amplify_resolution(long n, long Rr, long Rc, DOUBLEMATRIX *DTM1,
                        DOUBLEMATRIX *DTM2, T_INIT *UV1, T_INIT *UV2)
{
