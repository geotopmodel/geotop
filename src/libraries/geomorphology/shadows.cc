...
void Orizzonte1(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                      ...
                      if (curv->co[i][jj]==1 && I==0)
                      ...
                      else if (curv->co[i][jj]==1 && I!=0)
                        {
                          zenith=(Z0->co[I][J]-Z0->co[i][jj])
                                 /sqrt(pow((double)(I-i)*(double)delta,
                                           (double)2)+pow((double)(J-jj)*(double)delta,(double)2));
                          if (zenith<=tan(alfa))
                            {
                              shadow->co[i][jj]=0;
                              I=i;
                  ...
                  if (curv->co[i][j]==1 && I==0)
                  ...
                  else if (curv->co[i][j]==1 && I!=0)
                    {
                      zenith=(Z0->co[I][J]-Z0->co[i][j])
                             /sqrt(pow((double)(I-i)*(double)delta,
                                       (double)2)+pow((double)(J-j)*(double)delta,(double)2));
                      if (zenith<=tan(alfa))
                        {
                          shadow->co[i][j]=0;
                          I=i;
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte2(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte3(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
                  ...
                  if (curv->co[ii][j]==1 && I==0)
                  ...
                  else if (curv->co[ii][j]==1 && I!=0)
                    {
                      zenith=(Z0->co[I][J]-Z0->co[ii][j])
                             /sqrt(pow((double)(I-ii)*(double)delta,
                                       (double)2)+pow((double)(J-j)*(double)delta,(double)2));
                      if (zenith<=tan(alfa))
                        {
                          shadow->co[ii][j]=0;
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte4(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
                  ...
                  if (jj<=Z0->nch && Z0->co[i][jj]!=novalue)
                    {
                      ...
                      if (curv->co[i][jj]==1 && I==0)
                        ...
                        {
                          zenith=(Z0->co[I][J]-Z0->co[i][jj])
                                 /sqrt((double)pow((I-i)*(double)delta,
                                                   (double)2)+pow((double)(J-jj)*(double)delta,(double)2));
                          if (zenith<=tan(alfa))
                            {
                              shadow->co[i][jj]=0;
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte5(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte6(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
                  ...
                  if (ii<=Z0->nrh && Z0->co[ii][j]!=novalue)
                    {
                      ...
                      if (curv->co[ii][j]==1 && I==0)
                        ...
                        {
                          zenith=(Z0->co[I][J]-Z0->co[ii][j])
                                 /sqrt((double)pow((I-ii)*(double)delta,
                                                   (double)2)+pow((double)(J-j)*(double)delta,(double)2));
                          if (zenith<=tan(alfa))
                            {
                              shadow->co[ii][j]=0;
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte7(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
...
/*----------------------------------------------------------------------------------------------------------*/
void Orizzonte8(double delta,long quadrata,double beta,double alfa,
                DOUBLEMATRIX *Z0,
                SHORTMATRIX *curv,SHORTMATRIX *shadow, double novalue)
{
  /*=====================*/
