...
#define GEOT_DEAFAULT -1234
	...
	#define NC_GEOTOP_2D_MAP 2// variable type for 2D maps (e.g. radiation in a basin) in structured grid
	#define NC_GEOTOP_3D_MAP 3// variable type for 3D maps (e.g. temperature in depth in a basin) in structured grid
	#define NC_GEOTOP_2D_MAP_IN_CONTROL_POINT 52// variable type (e.g. radiation in a point)
	#define NC_GEOTOP_3D_MAP_IN_CONTROL_POINT 53// variable type for z_point (e.g. temperature in depth in a point)
	#define NC_GEOTOP_POINT_VAR 1
	#define NC_GEOTOP_Z_POINT_VAR 22// e.g. point_variable (Z,ID)
	#define NC_GEOTOP_0DIM_VAR 0
	#define NC_GEOTOP_UNSTRUCT_MAP 42 // variable type 2D maps vectorialized in unstructured way
	#define NC_GEOTOP_Z_UNSTRUCT_MAP 43  // variable type 3D maps vectorialized in unstructured way
	#define NC_GEOTOP_UNSTRUCT_MAP_IN_CONTROL_POINT 72// variable type (e.g. radiation in a point) in unstructured grid
	#define NC_GEOTOP_Z_UNSTRUCT_MAP_IN_CONTROL_POINT 73// variable type for z_point (e.g. temperature in depth in a point) in unstructured grid
#endif
#endif
