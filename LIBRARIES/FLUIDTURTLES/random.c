...
/* Quick random number genrator modified from Numerical Recipes */
...
*/
/*--------------------------------------------------------------------------*/
/* generator of random variables with lognormal distribution,
average vmed, standard deviation vvar */


double uuvel(float vmed,float vvar)
{
static long idum=3;//ibumb=-2;
float umed, uvar,u,v;
double y;
