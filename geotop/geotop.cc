            ...
            do{
                ...
                do{
...
#else
                    meteo_distr(A->M->line_interp_WEB, A->M->line_interp_WEB_LR, A->M, A->W, A->T, A->P, JD0, JDb, JDe); //TODO: importante
                    long ii,jj;
                    ...
                    if(A->P->en_balance == 1){
                        ...
                        en = EnergyBalance(Dt, JD0, JDb, JDe, L, C, S, G, V, a, A, &W, vec_meteo); //TODO: verificare, (forse le modifiche sono qui)
                    ...
                    if (en != 0 || wt != 0) {
                        ...
                        fprintf(f,"Reducing time step to %12g s, t:%12g s\n",Dt,t);
#else
                ...
                if (en != 0 || wt != 0) {
                    ...
                    if (en != 0 && wt == 0) {
                        fprintf(f, "ERROR: Energy balance does not converge, Dt:%12g\n",Dt);
                    }else if (en == 0 && wt != 0) {
                        fprintf(f, "ERROR: Water balance does not converge, Dt:%12g\n",Dt);
                    }else {
                        fprintf(f, "ERROR: Water and energy balance do not converge, Dt:%12g\n",Dt);
                    }
#else
