...
"**" instead substitutes:
shortarray,intarray,longarray,chararray,floatarray,doublearray,stringarray Any of the routines is commented in a standard way as follows:
---------------------------------------------------------------------------------*/
...
Inputs: name of the file and mode of openingReturn: a pointer to the opened file or a NULL pointer in the case of t_fclose
...
is returned.
Examples: 1.examples.c, 2.examples.c References:*/
...
void print_longvector_elements(LONGVECTOR *,long );long read_floatvector_elements(FILE *  ,FLOATVECTOR *,char *);
...
void print_charvector_elements(CHARVECTOR *,long );long read_shortmatrix_elements(FILE *, SHORTMATRIX *,char *);
...
void print_floatmatrix_elements(FLOATMATRIX *,long );long read_doublematrix_elements(FILE *, DOUBLEMATRIX *,char *);
...
void print_stringbin_elements(STRINGBIN *,long );long read_shortbin_elements(FILE *, SHORTBIN *,char *);
...
into its stringbin.FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.cAuthors & Date: Riccardo Rigon, August 1997Inputs: read_: A pointer to the buffer and a pointer to the stringbin.
...
Version: 1.0Description: reads a comment from a turtle file. read_comment prints it on the screen, readandstore_comment
...
Return:  a pointer to the buffer storedExamples: matrixconverter.c
...
Version: 1.0
Description: inspect a file a look for the string that starts a comment ("/"**")
...
Return: 1 if successful 0 otherwiseSee Also: read_comment, skip_whitespaces
...
Return:  a pointer to the resulting stringExamples: 1.examples.c
Authors & Date: Riccardo Rigon, October 1997
...
Return: the requested nameSee Also: simplefind, get_parameter, get_string*/
...
Inputs: 
1) The pointer to working directory name
2) The pointer to the name of the program being executedReturn: the requested string
...
FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.c
Authors & Date: Riccardo Rigon, February 1997Inputs: the pointer to the opened file
Return: void
...
Return: a HEADER Keywords: turtle file
Examples: 1.example.c */
...
of failure.See Also: read_comment, read_header
...
Authors & Date: Riccardo Rigon, February, September 1997FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.c
...
Return: the pointer to the appropriate structure where data are stored;  See Also: read_comment, read_header.
Keywords: turtle file
...
FLOATVECTOR * read_floatvector(FILE *, char *,short );DOUBLEVECTOR * read_doublevector(FILE *, char *,short );
...
/**
Name: read__Synopsis: INTVECTOR * read_intarray(FILE *,short );
Version: 1.0
Description: read_** reads a data set of the specified type;Authors & Date: Riccardo Rigon, September 1997
FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.c
Inputs: a pointer to a fileReturn: the structure read  See Also: read_comment, read_header.Keywords: turtle fileExamples: 1.example.c 
...
/**
Name: justread_floatarray, justread_chararray, justread_longarraySynopsis: void justread_floatarray(FILE *,FLOATVECTOR *,short );
Version: 1.0
Description: works as read_** but assumes that the vector containing
the data has been already allocatedAuthors & Date: Riccardo Rigon, November 1997
FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.cInputs: a pointer to a file, a pointer to the allocated strucure, PRINT or NOPRINT
to indicate if the header specification are printed on the standard output 
Return: void  See Also: read_comment, read_header, read__.
Keywords: turtle file
Examples: 5.example.c 6.example.c
...
Authors & Date: Riccardo Rigon, September 1997
Inputs: the pointers to the two header to compareFILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.cReturn: 0 if the HEADER are equal, a suitable number
...
in read_*binAuthors & Date: Riccardo Rigon, September 1997
...
Return: 1 if successfull See Also: read_header.
Keywords: turtle file
Examples: 1.example.c */
...
Return: void See Also: read_comment
Keywords: turtle file
Examples: 1.example.c.  
*/
...
Version: 1.0
Description: It writes: "This is a turtle file" and the date on a fileAuthors & Date: Riccardo Rigon, September 1997
FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.c
Inputs: the pointer to the file where to write, the string to write and the line\
length
Return: void See Also: read_comment
Keywords: turtle file
Examples:1.example.c */void write_comment(FILE *,const char *,long);
...
Version: 1.0
Description: writes a HEADER CONTENT to a fileAuthors & Date: Riccardo Rigon, September 1997FILE: LIBRARIES/BASICS/t_io.h, LIBRARIES/BASICS/t_io.cInputs: the pointer to the file where to write and a pointer to the header
where the information are stored
Return: voidSee Also: read_headerKeywords: turtle file
Examples: 1.example.c  
*/
