...
void drainagedirections_modify(DOUBLEMATRIX *,SHORTMATRIX *, DOUBLEVECTOR* U,DOUBLEVECTOR* V,SHORTMATRIX *);

/* old version with U, V floating point */                                              
void drainagedirections_modify_f(DOUBLEMATRIX *,SHORTMATRIX *, FLOATVECTOR* U,FLOATVECTOR* V,SHORTMATRIX *);
