...
//int ncgt_put_doublematrix_from_doubletensor_vs_time(DOUBLETENSOR *dt,long k, int ncid, const char *dimension_t, const char *suffix, const char *dimension_id, const char *dimension_z,LONGMATRIX *rc);
int ncgt_put_doublematrix_from_doubletensor_vs_time_par(DOUBLETENSOR *dt,long k, int ncid, WORKAREA *rankArea, const char *dimension_t, char *suffix,const char *dimension_id, const char *dimension_z,LONGMATRIX *rc);
//int ncgt_put_doublevector_from_doublematrix_vs_time(DOUBLEMATRIX *dt,long k, int ncid, const char *dimension_t, const char *suffix,const char *dimension_id, LONGMATRIX *rc);
int ncgt_put_doublevector_from_doublematrix_vs_time_par(DOUBLEMATRIX *dt,long k, int ncid, WORKAREA *rankArea, const char *dimension_t,  char *suffix,const char *dimension_id, LONGMATRIX *rc);
