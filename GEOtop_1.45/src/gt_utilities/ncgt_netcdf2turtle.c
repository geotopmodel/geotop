...
DOUBLEVECTOR *ncgt_new_doublevector_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension){
	/*!
	 *
	 *
...
DOUBLEMATRIX *ncgt_new_doublematrix_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *
	 *
...
//EV_S
FLOATVECTOR *ncgt_new_floatvector_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension){
	/*!
	 *
	 *
...
INTVECTOR *ncgt_new_intvector_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension){
	/*!
	 *
	 *
...
LONGVECTOR *ncgt_new_longvector_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension){
	/*!
	 *
	 *
...
SHORTVECTOR *ncgt_new_shortvector_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension){
	/*!
	 *
	 *
...
FLOATMATRIX *ncgt_new_floatmatrix_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *
	 *
...
SHORTMATRIX *ncgt_new_shortmatrix_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *
	 *
...
INTMATRIX *ncgt_new_intmatrix_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *
	 *
...
LONGMATRIX *ncgt_new_longmatrix_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *
	 *
...
DOUBLETENSOR *ncgt_new_doubletensor_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y,const char *dimension_z){
	/*!
	 *
	 *
...
int ncgt_get_doublematrix_level_l_par(DOUBLEMATRIX *M, long l,int ncid, WORKAREA *rankArea,const char *dimension_x, const char *dimension_y, const char *dimension_l) {
...
//221009_s
int ncgt_get_doublevector_level_l_par(DOUBLEVECTOR *v, long l,int ncid, WORKAREA *rankArea,const char *dimension_x, const char *dimension_l){
	/*!
	 *
	 *
	 * \author Enrico Verri
...
int ncgt_get_doubletensor_level_l_par(DOUBLETENSOR *t, long l,int ncid, WORKAREA *rankArea,const char *dimension_x, const char *dimension_y, const char *dimension_z, const char *dimension_l){
	/*!
	 *
	 *
	 * \author Enrico Verri
...
//
//NC_BYTE
signed char ncgt_get_byte_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
// NC_INT
int nc_get_int_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
// NC_SHORT
short nc_get_short_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
// NC_FLOAT
float nc_get_float_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
// NC_DOUBLE
double nc_get_double_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
// NC_LONG
long nc_get_long_par(int ncid,const char *varname)
{
	/*!
	 *
	 *
...
//201009_e
//131109_s
DOUBLETENSOR *ncgt_new_doubletensor_rotate180y_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y,const char *dimension_z){
	/*!
	 *\param fileneme - (char *) name of the NetCDF file
	 *\param varname  name of the variable
	 *\param dimension_x - (char *) name of the x dimension (number of column)
...
DOUBLEMATRIX *ncgt_new_doublematrix_rotate180y_par(int ncid, WORKAREA *rankArea,const char *varname, const char *dimension_x,const char *dimension_y){
	/*!
	 *\param fileneme - (char *) name of the NetCDF file
	 *\param varname  name of the variable
	 *\param dimension_x - (char *) name of the x dimension (number of column)
...
int ncgt_get_doubletensor_rotate180y_level_l_par(DOUBLETENSOR *t, long l,int ncid, WORKAREA *rankArea,const char *dimension_x, const char *dimension_y, const char *dimension_z, const char *dimension_l){
	/*!
	 *\param t - (DOUBLETENSOR *) variable from the NetCDF
	 *\param fileneme - (char *) name of the NetCDF file
	 *\param l        - (long) number of the level (0 based) at which the xyz map is printed
...
int ncgt_get_doublematrix_rotate180y_level_l_par(DOUBLEMATRIX *M, long l,int ncid, WORKAREA *rankArea,const char *dimension_x, const char *dimension_y, const char *dimension_l){
	/*!
	 *\param M - (DOUBLEMATRIX *) variable from the NetCDF
	 *\param fileneme - (char *) name of the NetCDF file
	 *\param l        - (long) number of the level (0 based) at which the xy map is printed
...
void nc_get_global_attr_lat_lon_min_max_par(int ncid,double *long_min,double *long_max,double *lat_min,double *lat_max){
	/*!
	 *
	 *
...
//131109_e
void nc_get_global_attr_missing_value_par(int ncid,double *missing_value){
	/*!
	 *
	 *
...
void nc_get_global_attr_resolution_par(int ncid,double *resolution){
	/*!
	 *
	 *
...
void nc_get_global_value_par(int ncid,char *attr_name,double *attr_value){
	/*!
	 *
	 *
