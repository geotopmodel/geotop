...
#include <turtle.h> // for DOUBLETENSOR, include also t_alloc.h
...
TEST(Tensor, TENSOR_value){
  ...
  // for(int k=0; k<pa->ndh; k++){
  //   for(int i=0; i<pa->nrh; i++){
  //     for(int j=0; j<pa->nch; j++){
