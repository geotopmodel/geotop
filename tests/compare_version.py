...
"""
This script will run in a geotop TEST_DIR (i.e.
``geotop.inpts`` file should be present) and will
check the output files against the files contained in the specified directory
subdirectory. (CHECK_DIR)
...
* for each OUTPUTDIR in TEST_DIR/CHECK_DIR:
...
* adding a subdirectory ``CHECKDIR`` containing the correct output
  files generated by geotop.

"""

__author__ = 'written by Antonio Messina <antonio.s.messina@gmail.com>, adapted by S.Cozzini'
...
TESTDIR = "/Users/cozzini/GEOTOP/github/geotop/tests"
# Path to the geotop binary
GEOTOP = "/Users/cozzini/GEOTOP/github/geotop/bin/geotop"
METEOIO_ACTUAL_STATUS = "off"
OUTPUT_TABS = "output-tabs" 
OUTPUT_MAPS = "output-maps" 
COMPARE_TABS = [OUTPUT_TABS+"-METEOIO-on", OUTPUT_TABS+"-METEOIO-off", OUTPUT_TABS+"-SE27XX"]
COMPARE_MAPS = [OUTPUT_MAPS+"-METEOIO-on", OUTPUT_MAPS+"-METEOIO-off", OUTPUT_MAPS+"-SE27XX"]
...
class TestValidRun(object):
    ...
    def _test_template(self, directory, results_dir):
        """
	...
	#assert_is_file(GEOTOP)
        ...
        resultdir = os.path.join(directory, results_dir)
        outputdir = os.path.join(directory, OUTPUT_TABS) 
