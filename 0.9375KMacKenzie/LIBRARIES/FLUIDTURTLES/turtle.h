...
#define isDynamic 1         /*This number will be used to mark a dynamic allocates quantity */
...
#define NOK -1
#define WOK 0
#define MAX_KEYWORD_LENGTH 10 /* era 8*/
#define PRINT 1
...
#define co element /* The "co" pointer within MATRIX, TENSOR and VECTOR structs contains the string or numerical elements of
					matrices, tensors and vectors, the word "co" can be replaced with "element" as previously utilized */
...
typedef struct{
	...
	short   type;                /* type of the vector to be stored:
	                                 ...
	                                 double=6, string=7 */
	short  category;            /* array=1, vector=2, matrix=3,list=4 tensor3d=5 */
