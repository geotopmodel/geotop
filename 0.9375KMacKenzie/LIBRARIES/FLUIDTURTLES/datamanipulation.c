...

{
  ...
  if(L!=NULL){
	...
	L->co[i]=sign;
      ...
      t_error("This vector was no properly allocated");
    }
  }else {
...

{
  ...
  max=U->co[U->nh]; /* added by Emanuele Cordano on 24 Septrember 2009 */
  min=U->co[U->nl]; /* added by Emanuele Cordano on 24 Septrember 2009 */
...

{
  ...
  minposition=1;
  maxposition=U->nh;
  min=U->co[minposition]; /* added by Emanuele Cordano on 25 September 2009 */
  max=U->co[maxposition];
...

{
  ...
  maxposition=U->nh;
  min=U->co[minposition]; /* added by Emanuele Cordano on 25 September 2009 */
  max=U->co[maxposition]; /* added by Emanuele Cordano on 25 September 2009 */
  delta=(max-min)/(N-1); /* added by Emanuele Cordano on 25 September 2009 */
...

{
  ...
  max=U->co[maxposition]; /* added by Emanuele Cordano on 24 September 2009 */
  min=U->co[minposition];  /* added by Emanuele Cordano on 24 September 2009 */
  logdelta=(log10(max)-log10(min))/(logbase*(N-1));  /* added by Emanuele Cordano on 24 September 2009 */
  if(N <=1){
    head=new_longpair();
    head->i=0;
    bins=head;
