...
DOUBLEVECTOR *nc_t_new_doublevector(const char *filename,const char *varname, const char *dimension){
	...
	*  \param filename (const char *) - name of the file
	...
	const char *function_name="nc_t_new_doublevector";
	size_t lengthp;
	DOUBLEVECTOR *v;
	int status;
	int ncid;
	...
	status=nc_open(filename,NC_SHARE,&ncid);
...
DOUBLEMATRIX *nc_t_new_doublematrix(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_doublematrix";
...
FLOATVECTOR *nc_t_new_floatvector(const char *filename,const char *varname, const char *dimension){
	...
	*  \param filename (const char *) - name of the file
	...
	const char *function_name="nc_t_new_floatvector";
	size_t lengthp;
	FLOATVECTOR *v;
	int status;
	int ncid;
...
FLOATMATRIX *nc_t_new_floatmatrix(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_floatmatrix";
	size_t lengthp_x,lengthp_y;
	FLOATMATRIX *m;
	int status;
	int ncid;
...
SHORTMATRIX *nc_t_new_shortmatrix(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_shortmatrix";
	size_t lengthp_x,lengthp_y;
	SHORTMATRIX *m;
	int status;
	int ncid;
...
INTMATRIX *nc_t_new_intmatrix(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_intmatrix";
	size_t lengthp_x,lengthp_y;
	INTMATRIX *m;
	int status;
	int ncid;
...
LONGMATRIX *nc_t_new_longmatrix(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_longmatrix";
	size_t lengthp_x,lengthp_y;
	LONGMATRIX *m;
	int status;
	int ncid;
...
DOUBLETENSOR *nc_t_new_doubletensor(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y,const char *dimension_z){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 */
//	double *val;
	const char *function_name="nc_t_new_doubletensor";
...
int nc_t_get_doublematrix_level_l(DOUBLEMATRIX *M, long l,const char *filename,const char *dimension_x, const char *dimension_y, const char *dimension_l) {
	...
	const char *function_name="nc_t_get_doublematrix_level_l";
...
int nc_t_get_doublevector_level_l(DOUBLEVECTOR *v, long l,const char *filename,const char *dimension_x, const char *dimension_l){
	...
	const char *function_name="nc_t_get_doublevector_level_l";
...
int nc_t_get_doubletensor_level_l(DOUBLETENSOR *t, long l,const char *filename,const char *dimension_x, const char *dimension_y, const char *dimension_z, const char *dimension_l){
	...
	const char *function_name="nc_t_get_doubletensor_level_l";
...
signed char nc_get_byte(const char *filename,const char *varname)
{
	...
	*  \param filename (const char *) - name of the file
	...
	const char *function_name="nc_get_byte";//
	signed char bvar;//
	int status;
	int ncid;
...
DOUBLETENSOR *nc_t_new_doubletensor_rotate180y(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y,const char *dimension_z){
	 ...
	 *\brief using the functions rotate180_y_doubletensor() and nc_t_new_doubletensor() .
	 *  IMPORTANT: only one NC_UNLIMITED dimension allowed
	 *  compile netcdf_lib with --enable-netcdf-4 option tu Turn on netCDF-4 features.
	 *
	...
	char *function_name="nc_t_new_doubletensor_rotate180y";
	int res = 0;

	dt=nc_t_new_doubletensor(filename,varname,dimension_x,dimension_y,dimension_z);
...
DOUBLEMATRIX *nc_t_new_doublematrix_rotate180y(const char *filename,const char *varname, const char *dimension_x,const char *dimension_y){
	 ...
	 *
	 *\brief This function read and rotates the variable contained in a netcdf
	 *\brief using the functions rotate180_y_doubletensor() and nc_t_get_doubletensor() .
	 *  IMPORTANT: only one NC_UNLIMITED dimension allowed
	 *  compile netcdf_lib with --enable-netcdf-4 option tu Turn on netCDF-4 features.
	 *
	 * \author Enrico Verri,Emanuele Cordano
	...
	dm=nc_t_new_doublematrix(filename,varname,dimension_x,dimension_y);
...
int nc_t_get_doubletensor_rotate180y_level_l(DOUBLETENSOR *t, long l,const char *filename,const char *dimension_x, const char *dimension_y, const char *dimension_z, const char *dimension_l){
	 ...
	 *\brief using the functions rotate180_y_doubletensor() and nc_t_get_doubletensor_level_l() .
	 *  IMPORTANT: only one NC_UNLIMITED dimension allowed
	 *  compile netcdf_lib with --enable-netcdf-4 option tu Turn on netCDF-4 features.
	 *
	 * \author Enrico Verri,Emanuele Cordano
	...
	char *function_name="nc_t_get_doubletensor_rotate180y_level_l";

	res=nc_t_get_doubletensor_level_l(t,l,filename,dimension_x,dimension_y,dimension_z,dimension_l);
	if (res!=0) printf("Error in %s: nc_t_get_doubletensor_level_l() did not work correctly  \n",function_name);
...
int nc_t_get_doublematrix_rotate180y_level_l(DOUBLEMATRIX *M, long l,const char *filename,const char *dimension_x, const char *dimension_y, const char *dimension_l){
	 ...
	 *\brief using the functions rotate180_y_doublematrix() and nc_t_get_doublematrix_level_l() .
	 *  IMPORTANT: only one NC_UNLIMITED dimension allowed
	 *  compile netcdf_lib with --enable-netcdf-4 option tu Turn on netCDF-4 features.
	 *
	 * \author Enrico Verri,Emanuele Cordano
	...
	char *function_name="nc_t_get_doublematrix_rotate180y_level_l";

	res=nc_t_get_doublematrix_level_l(M,l,filename,dimension_x,dimension_y,dimension_l);
	if (res!=0) printf("Error in %s: nc_t_get_doublematrix_level_l() did not work correctly  \n",function_name);
...
int nc_t_exist_doublevector(const char *filename,const char *varname, const char *dimension){
	...
	*  \param filename (const char *) - name of the file
	 ...
	 * \date November 2009
	 *
	 *\return 0 if variable exist, <> 0 if not exist.
	 */

	const char *function_name="nc_t_exist_doublevector";
	size_t lengthp;
	DOUBLEVECTOR *v;
	int status,res;
	int ncid;
	...
	res=nc_inq_varid(ncid,varname,&varid);
