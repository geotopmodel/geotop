...
/*----------------------------------------------------------------------------------------------------------*/
void snow_layer_combination(double a, long r, long c, STATEVAR_3D *snow, double Ta, long linf, DOUBLEVECTOR *Dmin, 
							DOUBLEVECTOR *Dmax, double SWEmax, double time, FILE *flog);
