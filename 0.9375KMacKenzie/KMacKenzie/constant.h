...
#define ndc 2.5
#define alpha_snow 1.E4// serve per la freezing characteristic della neve: piu' alto e' alpha, piu' e' angoloso, piu' basso, piu' e' curva
//Meteo data
...
#define itauC iSWd+1/*sky trasmissivity [-], range: [0.25,1]*/
#define iC	 itauC+1/*Cloudiness [-], range: [0,1]*/
#define iLWi iC+1	/*incoming longwave*/
#define iSWn iLWi+1	/*net shortwave*/
#define iTsup iSWn+1 /* Temperature of the soil surface (for Dirichlet conditions) */
#define nmet iTsup+1	/* number of meteo variables */
...
#define nsoilprop jlatfl				//number of soil properties considered
...
#define jLAI jz0thresveg+1			//LAI
#define jcf jLAI+1					//Canopy gap fraction (k)
...
#define jvR_vis jtfc+1				//vegetation in the visible spectrum
