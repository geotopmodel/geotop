...
#define I_METEO_LAPSERATES	 I_METEO_PRIMARY+1 /* text file containing the lapse rates (T,Tdew...)*/
#define	I_METEO_HORIZON	     I_METEO_LAPSERATES+1	/*	 text file containing the horizons for each stations (without extension and meteo station number)	*/
...
#define	O_K_pH			O_MELT_FLUXES_vs_LANDUSE+1	/* plot of the sensible heat flux		*/
#define	O_K_pLE			O_K_pH+1	/*		*/
#define O_K_pHg			O_K_pLE+1	/*	specific day map plots(p.) sensible heat flux */
#define O_K_pLEg		O_K_pHg+1	/*	p. latent heat flux */
#define O_K_pHv								O_K_pLEg+1	/*		*/
#define O_K_pLEv							O_K_pHv+1	/*		*/
#define	O_K_pSWin							O_K_pLEv+1	/* 	*/
#define O_K_pSWg							O_K_pSWin+1	/* p. outgoing shortwave radiation */
#define O_K_pSWv							O_K_pSWg+1	/*		*/
#define	O_K_pLWin							O_K_pSWv+1	/*	 to be commented by Stefano Endrizzi	*/
#define O_K_pLWg							O_K_pLWin+1	/* p. outgoing longwave radiation */
#define O_K_pLWv							O_K_pLWg+1	/*		*/
#define	O_K_pTs								O_K_pLWv+1	/*	i	*/
#define O_K_pTg								O_K_pTs+1	/*		*/
#define O_K_pTv								O_K_pTg+1/*		*/
#define	O_K_pTa								O_K_pTv+1/*	 to be commented by Stefano Endrizzi	*/
...
#define REC_SNOWAGE_ADIM							REC__h_sup+1 	/*recover file for snow age adimensional*/
#define REC_SNOWAGE_DIM								REC_SNOWAGE_ADIM+1		/*recover file for snow age dimensional,*/
#define REC_WATER_STORED_CANOPY_RAIN 				REC_SNOWAGE_DIM+1	/*recover file for water stored on canopy in form of rain,*/
#define REC_WATER_STORED_CANOPY_SNOW 				REC_WATER_STORED_CANOPY_RAIN+1 /*recover file for water stored on canopy in form of snow,*/
#define REC_TEMPERATURE_VEGETATION 					REC_WATER_STORED_CANOPY_SNOW+1 /*recover file for temperature of vegetation,*/
#define	REC__wt	                                    REC_TEMPERATURE_VEGETATION+1	/*	 recover file for wt (without extension)	*/
...
#define	O_SOILTEMPERTURE_MEAN_CONTROLPIXELS			zSFA+1 /*	 output text files with time series of the mean soil temperature in the plot interval at the control pixels (without extension) 	*/
#define	O_PRESSUREHEAD_MEAN_CONTROLPIXELS			O_SOILTEMPERTURE_MEAN_CONTROLPIXELS+1/*	 output text files with time series of the mean soil psi in the plot interval at the control pixels (without extension) 	*/
#define	O_WATERCONTENT_MEAN_CONTROLPIXELS			O_PRESSUREHEAD_MEAN_CONTROLPIXELS+1/*	 output text files with time series of the mean soil theta_w in the plot interval at the control pixels (without extension) 	*/
#define	O_ICECONTENT_MEAN_CONTROLPIXELS				O_WATERCONTENT_MEAN_CONTROLPIXELS+1/*	 output text files with time series of the mean soil theta_i in the plot interval at the control pixels (without extension) 	*/
#define SUPERFAST_FILE								O_ICECONTENT_MEAN_CONTROLPIXELS+1
...
//#define supfs										ficez_mean+1/* output file of the superfast version*/
//#define O_Bugs									supfs+1
#define	nfiles  									SUPERFAST_FILE /*number of files */
...
#define fLRs	I_METEO_LAPSERATES /* text file containing the lapse rates (T,Tdew...)*/
...
#define	fsndur	O_SNOW_DURATION_DISTRIBUTED_MAP	/*	  output 2D plus time tensor for snow duration [days] distributed  in the whole basin (without extension) 	*/
#define	fsnav	O_AVERAGE_SNOW_FROM_BEGGIN_DISTRIBUTED_MAP	/*	 output 2D plus time tensor for average snow depth [mm] since begin of simulation distributed  in the whole basin (without extension) 	*/
...
#define supfs		SUPERFAST_FILE /* output of the superfast version */

#define	pH		O_K_pH	/* specific day map plots(p.) for the sensible heat flux		*/
#define	pLE		O_K_pLE	/*	specific day map plots(p.) for the Latent heat flux (LEg + LEv = LE sum of the ground and vegentation component)	*/
#define pHg 	O_K_pHg	/*	specific day map plots(p.) for sensible heat flux */
#define pLEg 	O_K_pLEg	/*	p. latent heat flux */
#define pHv		O_K_pHv	/*	sensible heat flux of the vegetation	*/
#define pLEv	O_K_pLEv	/*	Latent heat flux of the vegetation	*/
#define	pSWin	O_K_pSWin	/* 	incoming SW*/
#define pSWg 	O_K_pSWg	/* SW absorbed by the soil */
#define pSWv	O_K_pSWv	/* SW absorbed by the vegetation */
#define	pLWin	O_K_pLWin	/*	incoming LW	*/
#define pLWg 	O_K_pLWg	/* LW absorbed by the soil */
#define pLWv	O_K_pLWv	/*	LW absorbed by the vegetation	*/
#define	pTs		O_K_pTs	/*	Surface temperature, be it snow or soil	*/
#define pTg		O_K_pTg	/*	Ground temperature	*/
#define pTv		O_K_pTv/*	Vegetation temperature	*/
#define	pTa	O_K_pTa	/*	 Air tempeature	*/
#define	pVspd	O_K_pVspd	/*	 wind speed map	*/
#define	pVdir	O_K_pVdir	/*	 wind direction map	*/
#define	pRH	O_K_pRH	/*	 Rel humidity map	*/
#define	pD	O_K_pD	/*	 snow depth	*/
#define	pth	O_K_ptheta	/*	 water content of the most superficial layer	*/
...
#define rsnag_adim REC_SNOWAGE_ADIM 	/* r. snow age */
#define rsnag_dim	REC_SNOWAGE_DIM
#define rwcrn	REC_WATER_STORED_CANOPY_RAIN/* r. water stored on canopy */
#define rwcsn	REC_WATER_STORED_CANOPY_SNOW
#define rTv		REC_TEMPERATURE_VEGETATION
...
//#define fbugs O_Bugs	/* file buffer to plot whatever needed */
